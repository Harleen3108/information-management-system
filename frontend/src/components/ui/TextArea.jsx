...
const TextArea = ({ label, id, error, className = '', ...props }) => (
  <div className={className}>
    ...
    <textarea id={id} {...props}
      className={`w-full px-3 py-2 bg-white dark:bg-zinc-800 border rounded-lg text-sm text-gray-900 dark:text-zinc-100 placeholder:text-gray-400 dark:placeholder:text-zinc-500 outline-none transition-all duration-150 resize-none
        ${error
